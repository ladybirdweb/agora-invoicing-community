 ...
 * Generated for Laravel 6.13.1 on 2020-04-08 18:41:24.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Artisan {
        ...
        public static function execute($schedule, $task)
        {
                        ...
                        return $instance->execute($schedule, $task);
        }
        ...
        {
                        /** @var \App\Console\Kernel $instance */
                        return $instance->getCondition($schedule, $command);
        }
        ...
        {
                        /** @var \App\Console\Kernel $instance */
                        return $instance->getConditionWithOption($schedule, $command, $at);
        }
...
namespace Torann\Currency\Facades { 
    ...
    class Currency {
         ...
         * @static 
         */ 
        public static function getIndianCurrencyFormat($number)
        {
                        /** @var \Torann\Currency\Currency $instance */
                        return $instance->getIndianCurrencyFormat($number);
        }
