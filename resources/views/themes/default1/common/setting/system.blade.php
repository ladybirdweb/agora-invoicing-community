                        ...
                        <td>
                            <div class="form-group {{ $errors->has('logo') ? 'has-error' : '' }}">
                                ...
                                <img src='{{ $set->admin_logo }}' class="img-thumbnail" style="height: 50px;">&nbsp;&nbsp;
                                 ...
                                 <button  type="button"  id="{{$set->id}}" data-url=""  data-toggle="tooltip"  value="admin" class="btn btn-sm btn-secondary show_confirm " label="" style="font-weight:500;" name="logo" value="client_logo" title="{{ __('message.delete_logo') }}" style="background-color: #6c75c7d;">
                        ...
                        <td>
                            <div class="form-group {{ $errors->has('icon') ? 'has-error' : '' }}">
                                ...
                                <img src='{{ $set->fav_icon }}' class="img-thumbnail" style="height: 50px;">&nbsp;&nbsp;
                                      ...
                                      <button  type="button"  id="{{$set->id}}" data-url=""  data-toggle="tooltip"  value="fav" class="btn btn-sm btn-secondary show_confirm " label="" style="font-weight:500;" name="logo" value="client_logo" title="{{ __('message.delete_logo') }}" style="background-color: #6c75c7d;">
                                <i class="fa fa-trash"></i></button>
                                @else
                                 {!! Form::file('fav-icon') !!}
                                @endif
                        ...
                        <td>
                            <div class="form-group {{ $errors->has('logo') ? 'has-error' : '' }}">
                                ...
                                <img src='{{ $set->logo }}' class="img-thumbnail" style="height: 50px;"> &nbsp;&nbsp;
                                 ...
                                 <button  type="button"  id="{{$set->id}}" data-url=""  data-toggle="tooltip"  value="logo" class="btn btn-sm btn-secondary show_confirm " label="" style="font-weight:500;" name="logo" value="client_logo" title="{{ __('message.delete_logo') }}" style="background-color: #6c75c7d;">
                                <i class="fa fa-trash"></i></button>
                                @else
                                {!! Form::file('logo') !!}
