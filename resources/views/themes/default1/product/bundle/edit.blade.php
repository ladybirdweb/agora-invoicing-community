...
<div class="box box-primary">
    ...
    <div class="content-header">
        {!! Form::model($bundle,['url'=>'bundles/'.$bundle->id,'method'=>'patch']) !!}
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group {{ $errors->has('valid_from') ? 'has-error' : '' }}">
                        ...
                        {!! Form::date('valid_from',$from,['class' => 'form-control']) !!}
                    ...
                    <div class="col-md-4 form-group {{ $errors->has('valid_till') ? 'has-error' : '' }}">
                        ...
                        {!! Form::date('valid_till',$till,['class' => 'form-control']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group {{ $errors->has('items.0') ? 'has-error' : '' }}">
                        ...
                        {!! Form::select('items[]',[''=>'Select','Products'=>$products],$relation,['class'=>'form-control','multiple'=>true]) !!}
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <div class="form-group {{ $errors->has('allow_promotion') ? 'has-error' : '' }}">
                                    ...
                                    <p>{!! Form::checkbox('allow-promotion',1) !!}  {{Lang::get('message.tick-to-allow-promotion-codes-to-be-used-in-conjunction-with-this-bundle')}}</p>
                                </div>
                            </li>
