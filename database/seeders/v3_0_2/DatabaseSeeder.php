...
{	
    ...
    class TemplateTableSeeder extends Seeder
   {
     public function run()
    {
          ...
          Template::create(['id' => 17, 'name' => '[Faveo Cloud] Your Faveo cloud plan has expired', 'type' => 17, 'url' => 'null', 'data' => '<table style="background: #f2f2f2; width: 700px;" border="0" cellspacing="0" cellpadding="0">
            <tbody>
            <tr>
            <td style="width: 30px;">&nbsp;</td>
            <td style="width: 640px; padding-top: 30px;">
          ...
          Template::create(['id' => 18, 'name' => '[Faveo Cloud]  Your Faveo cloud is  expiring soon', 'type' => 18, 'url' => 'null', 'data' => '<table style="background: #f2f2f2; width: 700px;" border="0" cellspacing="0" cellpadding="0">
            <tbody>
            <tr>
            <td style="width: 30px;">&nbsp;</td>
            <td style="width: 640px; padding-top: 30px;">
            ...
            <p>&nbsp;</p>']);
                     ...
                     Template::create(['id' => 19, 'name' => '[Faveo Cloud] Your  Faveo cloud instance is deleted', 'type' => 19, 'url' => 'null', 'data' => '<table style="background: #f2f2f2; width: 700px;" border="0" cellspacing="0" cellpadding="0">
            <tbody>
            <tr>
            <td style="width: 30px;">&nbsp;</td>
            <td style="width: 640px; padding-top: 30px;">
