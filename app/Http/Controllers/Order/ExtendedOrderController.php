    ...
    private function getBaseQueryForOrders()
    {
        return Order::leftJoin('subscriptions', 'orders.id', '=', 'subscriptions.order_id')
            ...
            ->select(
                ...
                'subscriptions.update_ends_at as subscription_ends_at', 'subscriptions.id as subscription_id', 'subscriptions.version as product_version', 'subscriptions.created_at as subscription_created_at', 'subscriptions.updated_at as subscription_updated_at',
