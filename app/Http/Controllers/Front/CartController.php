...
class CartController extends Controller {
    ...
    public function Cart(Request $request) {
        try {
            $id = $request->input('id');
            if (!key_exists($id, Cart::getContent()->toArray())) {
                ...
                if ($enabled == 1 && $type == 'exclusive') {
                    ...
                    if ($isTaxApply == 1) {
                        ...
                        if ($tax1) {
                            $name1 = $tax1->name;
                            $rate1 = $tax1->rate;
                            $taxCondition1 = new \Darryldecode\Cart\CartCondition(array(
                                'name' => $name1,
                                'type' => 'tax',
                                'target' => 'item',
                                'value' => $rate1 . '%',
                        ...
                        if ($tax2) {
                            $name2 = $tax2->name;
                            $rate2 = $tax2->rate;
                            $taxCondition2 = new \Darryldecode\Cart\CartCondition(array(
                                'name' => $name2,
                                'type' => 'tax',
                                'target' => 'item',
                                'value' => $rate2 . '%',
