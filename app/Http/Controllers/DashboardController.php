...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('themes.default1.common.dashboard', compact('totalSalesINR', 'totalSalesUSD', 'yearlySalesINR', 'yearlySalesUSD', 'monthlySalesINR', 'monthlySalesUSD', 'users', 'count_users'));
    }
