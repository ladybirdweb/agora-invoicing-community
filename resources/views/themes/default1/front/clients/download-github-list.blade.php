<a onclick="getTables({{$productid}},{{$clientid}},{{$invoiceid}})" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#lists">  <i class='fa fa-download' style="color:white;" title=Download>&nbsp;Download</i></a>
<style>
