    ...
    */
    public function parse_sql($sql, $as_is = false)
    {
        ...
        /*
          ...
          */
        if (count($table_data) > 1 && !preg_match('#.*group by.*#i', $table_data[1])) { //where construction exists
...
class DataConfig
{
    ...
    */
    ...
    public function limit_fields($data)
    {
        ...
        for ($i = 0; $i < count($this->full_field_list); $i++) {
