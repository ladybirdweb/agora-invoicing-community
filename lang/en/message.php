...
return [
    ...
    */
    ...
    'cname' => 'Your domain\'s DNS CNAME record is not pointing to our cloud. Please ensure that the CNAME record is correctly set to proceed with the desired action.',
