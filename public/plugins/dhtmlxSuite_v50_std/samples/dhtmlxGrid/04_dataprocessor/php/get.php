...
if ($res) {
    while ($row = mysql_fetch_array($res)) {
        ...
        echo '<cell><![CDATA['.$row['sales'].']]></cell>';
        echo '<cell><![CDATA['.$row['title'].']]></cell>';
        echo '<cell><![CDATA['.$row['author'].']]></cell>';
        echo '<cell><![CDATA['.$row['price'].']]></cell>';
        echo '<cell><![CDATA['.$row['instore'].']]></cell>';
        echo '<cell><![CDATA['.$row['shipping'].']]></cell>';
        echo '<cell><![CDATA['.$row['bestseller'].']]></cell>';
        echo '<cell><![CDATA['.gmdate('m/d/Y', strtotime($row['pub_date'])).']]></cell>';
        echo '</row>';
    }
} else {
    //error occurs
