                                                ...
                                                <div class="form-group col-12 ">
                                                    <div class="row">
                                                        <div class="form-group col">
                                                            ...
                                                            @php $links = [['google', 'Google', 'fa-google'], ['twitter', 'Twitter', 'fa-twitter'], ['github', 'Github', 'fa-github'], ['linkedin', 'Linkedin', 'fa-linkedin']]; @endphp

                                                            @php $links = [['google', 'Google', 'fa-google'], ['twitter', 'Twitter', 'fa-twitter'], ['github', 'Github', 'fa-github'], ['linkedin', 'Linkedin', 'fa-linkedin']]; @endphp

                                                            @foreach ($links as $link)
                                                            @if (isset(${$link[0] . '_status'}) && ${$link[0] . '_status'} == 1) <a href="{{ url('/auth/redirect/' . $link[0]) }}" class="btn btn-primary-scale-2 m-1 @if ($link[0] === 'google') btn-modern @else social_buttons @endif w-100 text-transform-none rounded-2 font-weight-bold align-items-center d-inline-flex justify-content-center text-3 py-2" data-loading-text="Loading..."><i class="fab {{ $link[2] }} text-5 me-2"></i>&nbsp Login With {{ $link[1] }}</a> @endif
                                                            @endforeach
                                                        </div>
                                                    </div>
                                                </div>
...
<noscript>
    <img height="1" width="1" src="https://www.facebook.com/tr?id=308328899511239&ev=PageView
&noscript=1" />
</noscript>
