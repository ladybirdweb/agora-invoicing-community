...
//dd($result);
    ...
    static function rounding($price) {
        try {
    ...
    static function findCountryByGeoip($iso) {
        try {
    ...
    static function findStateByRegionId($iso) {
        try {
            if ($iso) {
    ...
    static function getTimezoneByName($name) {
        try {
            if ($name) {
    ...
    static function getStateByCode($code) {
        try {
            if (is_int($code)) {
                return [];
            }
    ...
    static function calculateTax($productid, $currency, $cart = 1, $cart1 = 0, $shop = 0) {
        try {
    ...
    static function taxValue($rate, $price) {
        try {
