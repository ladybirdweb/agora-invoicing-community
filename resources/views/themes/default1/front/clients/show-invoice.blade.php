        ...
        <div id="examples" class="container py-4" style="max-width: 900px">
            ...
            <div class="row pt-3">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list list-unstyled text-2 mb-0">
                        ...
                        {{ __('message.email')}}: {{$user->email}}<br />
                        @if($user->gstin)
                    ...
                    @foreach($items as $item)
                        ...
                        <tr>
                            ...
                            <td> {!! $orderForThisItem->getOrderLink($orderForThisItem->id,'my-order') !!}</td>
                                ...
                                @elseif($order != '--')
                                <td>{!! $order !!}
                                <span class='badge badge-warning'>{{ __('message.renewed')}}</span></td>
                                @else
                                <td>--</td>
                            @endif
                            @php
          ...
          @if(!$payments->isEmpty())
            ...
            <div class="mt-4">
                ...
                <a href="{{url('pdf?invoiceid='.$invoice->id)}}" onclick="refreshPage()"  class="btn btn-dark float-end ms-2"><i class="fa fa-download"></i> {{ __('message.generate_pdf')}}</a>
