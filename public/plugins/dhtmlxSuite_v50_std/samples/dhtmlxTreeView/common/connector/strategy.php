...
class TreeRenderStrategy extends RenderStrategy
{
    ...
    public function __construct($conn)
    {
        ...
        $conn->event->attach('afterInsert', [$this, 'parent_id_correction_a']);
        $conn->event->attach('beforeProcessing', [$this, 'parent_id_correction_b']);
    }
...
class MultitableTreeRenderStrategy extends TreeRenderStrategy
{
    ...
    {
        parent::__construct($conn);
        $conn->event->attach('beforeProcessing', [$this, 'id_translate_before']);
        $conn->event->attach('afterProcessing', [$this, 'id_translate_after']);
    }
...
class GroupRenderStrategy extends RenderStrategy
{
    ...
    {
        parent::__construct($conn);
        $conn->event->attach('beforeProcessing', [$this, 'check_id']);
        $conn->event->attach('onInit', [$this, 'replace_postfix']);
    }
