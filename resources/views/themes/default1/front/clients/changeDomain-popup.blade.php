                    ...
                    <form action="" method="post" style="width:500px; margin: auto auto;" class="card card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row" style="margin-left: 2px; margin-right: 2px;">
                                ...
                                <input  type="text" name="userdomain" autocomplete="off" id= "userdomain"  class="form-control col col-12" placeholder="cloud.fratergroup.in" required>
                            ...
                            <div class="row" style="margin-left: 2px; margin-right: 2px;">
                                <input type="hidden"  name="order" id="orderId" value=""/>
                                <input  type="text" name="usernewdomain" autocomplete="off" id= "usernewdomain"  class="form-control col col-12" placeholder="cloud.fratergroup.in" required>
                                <!-- <input type="text" class="form-control col col-8" value=".fratergroup.in" disabled="true">-->
                            </div>
                        </div>
                    </form>
